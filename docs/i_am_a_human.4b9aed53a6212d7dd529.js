/******/ (() => { // webpackBootstrap
let blocks = (/* unused pure expression or super */ null && ([]));
let particles = (/* unused pure expression or super */ null && ([]));
let block_x = 150;
let block_y = 10;
...
let start_y = 560;
let collapse = false;
let words = (/* unused pure expression or super */ null && ([]));
let languages = (/* unused pure expression or super */ null && (["Babylon", "Вавилон", "Babülon", "Babilonia", "Babilòn", "Babilon", "iBhabhiloni"]));
...
function setup() {
  textFont(font);
  createCanvas(displayWidth - displayWidth * 0.015, displayHeight - displayHeight * 0.2);
...
function generateWords() {
  ...
  for (let i = 0; i < 60; i++) {
    let word = {
      ...
      size: random(15, 30),
      speed: random(1, 3),
      // Случайная скорость падения для слов
      color: "white"
    };
    words.push(word);
  }
